...
(define (scheme-execute-square board x y board-out nr-hugs grow-beard moving-rocks)
...
(define (execute-square board x y board-out nr-hugs grow-beard moving-rocks)
  (if call-c-code
  (call-native-execute-square board x y board-out nr-hugs grow-beard moving-rocks)
  (scheme-execute-square board x y board-out nr-hugs grow-beard moving-rocks)
))
