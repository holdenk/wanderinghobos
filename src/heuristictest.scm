...
(test-group "score-world"
	    ...
	    (test 2.2 (fairly-heuristic-world 3 (list ) world-test-1))
	    (test 2.1 (fairly-heuristic-world 3 (list 'up) world-test-2))
	    (test -20.7 (fairly-heuristic-world 3 (list 'left) world-test-3))
	    (test 2 (verry-heuristic-world 3 (list ) world-test-1))
	    (test 2 (very-heuristic-world 3 (list 'up) world-test-2))
	    (test -21 (very-heuristic-world 3 (list 'left) world-test-3))
